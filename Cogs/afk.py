...
class OnOrOff(BasicView):
    ...
    @discord.ui.button(label="Yes", emoji="<:unnamed:1227638126428819456>", custom_id='Yes', style=discord.ButtonStyle.green)
...
class afk(commands.Cog):
    ...
    async def on_message(self, message):
      try:
        ...
        if message.mentions:
            for user_mention in message.mentions:
                if afk[f'{user_mention.id}']['AFK'] == 'True':
                    ...
                    wl = discord.Embed(description=f'**{str(user_mention)}** went AFK <t:{ok}:R> : {reason}', color=0x460254)
                    ...
                    embed.set_image(url="https://cdn.discordapp.com/attachments/1210268753036705882/1222035306908487811/tenor.gif?ex=6614c011&is=66024b11&hm=b182e12233f28d2d21989cc3&")
                ...
                if afk[f'{message.author.id}']['AFK'] == 'True':
                    ...
                    wlba = discord.Embed(description=f'Welcome Back {str(message.author.mention)}, You got **{mentionz}** Mentions while You were AFK, I removed your AFK. You were afk for **{been_afk_for}**', color=0x460254)
                    wlba.set_image(url="https://cdn.discordapp.com/attachments/1210268753036705882/1222035306908487811/tenor.gif?ex=6614c011&is=66024b11&hm=0c9709e20e1a0f6bac229dd72d7f21e98e112718b182e12233f28d2d21989cc3&")
                    ...
                    if afk[f'{user_mention.id}']['AFK'] == 'True':
                        ...
                        reason = afk[f'{user_mention.id}']['reason']
                        ok = afk[f'{user_mention.id}']['time']
                        wlt = discord.Embed(description=f'**{str(user_mention)}** went AFK <t:{ok}:R> : {reason}', color=0x460254)
                        wlt.set_image(url="https://cdn.discordapp.com/attachments/1210268753036705882/1222035306908487811/tenor.gif?ex=6614c011&is=66024b11&hm=0c9709e20e1a0f6bac229dd72d7f21e98e112718b182e12233f28d2d21989cc3&")
                        ...
                        embed.add_field(name="Contents:", value=message.content, inline=False)
                        embed.add_field(name="Jump Url:", value=f"[Jump To Message]({message.jump_url})", inline=False)
                        embed.set_image(url="https://cdn.discordapp.com/attachments/1210268753036705882/1222035306908487811/tenor.gif?ex=6614c011&is=66024b11&hm=0c9709e20e1a0f6bac229dd72d7f21e98e112718b182e12233f28d2d21989cc3&")
        ...
        if afk[f'{message.author.id}']['AFK'] == 'True':
            ...
            afk[f'{message.author.id}']['guild'].remove(message.guild.id)
            afk[f'{message.author.id}']['reason'] == None
            wlbat = discord.Embed(description=f'Welcome Back {str(message.author.mention)}, You got **{mentionz}** Mentions while You were AFK, I removed your AFK. You were afk for **{been_afk_for}**', color=0x460254)
            wlbat.set_image(url="https://cdn.discordapp.com/attachments/1210268753036705882/1222035306908487811/tenor.gif?ex=6614c011&is=66024b11&hm=0c9709e20e1a0f6bac229dd72d7f21e98e112718b182e12233f28d2d21989cc3&")
    ...
    async def afk(self, ctx, *, reason=None):
        ...
        if 'discord.gg' in reason:
            emd = discord.Embed(description=f"You can't Advertise in Afk Reason", color=0x460254)
            emd.set_image(url="https://cdn.discordapp.com/attachments/1210268753036705882/1222035306908487811/tenor.gif?ex=6614c011&is=66024b11&hm=0c9709e20e1a0f6bac229dd72d7f21e98e112718b182e12233f28d2d21989cc3&")
        ...
        if '.gg/' in reason:
            eme = discord.Embed(description=f"You can't Advertise in Afk Reason", color=0x460254)
            eme.set_image(url="https://cdn.discordapp.com/attachments/1210268753036705882/1222035306908487811/tenor.gif?ex=6614c011&is=66024b11&hm=0c9709e20e1a0f6bac229dd72d7f21e98e112718b182e12233f28d2d21989cc3&")
            return await ctx.send(embed=eme)

        view = OnOrOff(ctx)


        em = discord.Embed(description="Shall the bot DM you on every mention while you're afk?", color=0x460254)
        em.set_image(url="https://cdn.discordapp.com/attachments/1210268753036705882/1222035306908487811/tenor.gif?ex=6614c011&is=66024b11&hm=0c9709e20e1a0f6bac229dd72d7f21e98e112718b182e12233f28d2d21989cc3&")
        try:
        ...
        await test.delete()
        af = discord.Embed(description=f'{ctx.author.mention} Your AFK is now set to: {reason}', color=0x460254)
        af.set_image(url="https://cdn.discordapp.com/attachments/1210268753036705882/1222035306908487811/tenor.gif?ex=6614c011&is=66024b11&hm=0c9709e20e1a0f6bac229dd72d7f21e98e112718b182e12233f28d2d21989cc3&")
