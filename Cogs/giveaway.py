...
class Giveaway(commands.Cog):
    ...
    async def start(self, ctx, duration: str, winners: int,*,prize: str,):
        ...
        embed = discord.Embed(title="<a:Giveaway:1221844411051278388> **Giveaway**<a:Giveaway:1221844411051278388>", description=f" **React with <a:Giveaway:1221844411051278388> to participate and win** `{prize}`\n───────────────────────────\n **`Hosted by`** {ctx.author.mention}",color=0x410142)
        ...
        while duration_seconds > 0:
            ...
            embed.set_field_at(0, name=" `Time Left`", value=f' {time_left}')
